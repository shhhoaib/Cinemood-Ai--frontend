...
export const getReviews = (contentType, contentId) => api.get(`/reviews/${contentType}/${contentId}`)
export const createReview = (data, token) => api.post('/reviews', data, { headers: { Authorization: `Bearer ${token}` } })
